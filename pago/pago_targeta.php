...
<body>
  <div class="container">
    ...
    <form action='admin.php' method='post'>
      ...
      <input type="text" id="Importe" name="importe" placeholder="Importe" value="<?php echo $_SESSION['importe']; ?>"
        required>
      ...
      <input type="submit" name="pagar" value="Pagar" href="../php/cerrar-compra.php">
      <button><a type="submit" a href="../php/carrito-principal.php">Regresar</a></button>
    </form>
  </div>
</body>
